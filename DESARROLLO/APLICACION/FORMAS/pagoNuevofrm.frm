...
Private Function dameArchivo() As String
    ...
    If gEncriptado = "NO" Then
        ...
        cmdListaPagos.DialogTitle = "Importar pagos de créditos."
        ...
        Select Case sprPago(MODO_MANUAL).ActiveCol
            ...
            Case Is = COL_FOLIO
                ...
                If existeValorEnGrid(sprPago(MODO_MANUAL), COL_FOLIO, lFactura, lRowAnt) = True Then
                    ...
                    pnlMsg.Caption = "¡El No. de Factura " & lFactura & " ya se capturó, verifique por favor!" ', vbInformation + vbOKOnly
                    sprPago(MODO_MANUAL).Col = COL_PAGO
                ...
                Else
                    ...
                    If oPago.registrado(lFactura, Format(Now(), "dd/mm/yyyy")) Then
                        ...
                        pnlMsg.Caption = "¡Ya hay un pago registrado el día de hoy para el crédito con folio" & " " & sprPago(MODO_MANUAL).Text & ", " & "verifique por favor!"
                        sprPago(MODO_MANUAL).Col = COL_PAGO
                        sprPago(MODO_MANUAL).Row = lRowAnt
                        sprPago(MODO_MANUAL).Action = ActionActiveCell
...
'    If MsgBox("Los pagos capturados están correctos?", vbQuestion + vbYesNo, "Registro de Pagos") = vbYes Then
'
'        Dim oPago As New Pago
'
...
Private Sub cmdregistra_Click()
    ...
    If MsgBox("Los pagos están correctos?", vbQuestion + vbYesNo, "Registro de Pagos") = vbYes Then
...
'    Dim hora As String
'
'    If MsgBox("Los pagos registrados están correctos?", vbYesNo, "Registro de Pagos") = vbYes Then
'
'        For i = 1 To grdpagos.Rows - 2
'            grdpagos.Row = i
'            grdpagos.Col = 1
...
'    total = oCampo.Valor
'
'    Set oCampo = cRegistro(8) 'Fecha inicio crédito
